...
// Instalação do Service Worker - DESABILITADO EM DEV
...
self.addEventListener("fetch", (event) => {
  ...
  // TEMPORARIAMENTE DESABILITADO - Permitir navegação normal
  // Não interfere com requisições durante desenvolvimento
  return;
